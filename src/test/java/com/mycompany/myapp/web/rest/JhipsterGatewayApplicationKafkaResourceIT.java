...
import com.mycompany.myapp.JhipsterGatewayApplicationApp;
import com.mycompany.myapp.service.JhipsterGatewayApplicationKafkaProducer;
import com.mycompany.myapp.service.JhipsterGatewayApplicationKafkaConsumer;
...
public class JhipsterGatewayApplicationKafkaResourceIT {
    ...
    @Autowired
    private JhipsterGatewayApplicationKafkaProducer producer;

    @Autowired
    private JhipsterGatewayApplicationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterGatewayApplicationKafkaResource kafkaResource = new JhipsterGatewayApplicationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-gateway-application-kafka/publish?message=test"))
